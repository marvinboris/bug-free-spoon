...
/* harmony import */ var _store_actions_backend_languages__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../../store/actions/backend/languages */ "./resources/js/src/store/actions/backend/languages.js");
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          _this$props$backend$l2 = _this$props$backend$l.languages,
          languages = _this$props$backend$l2 === void 0 ? [] : _this$props$backend$l2,
      ...
      var data = languages.map(function (language) {
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_9__.updateObject)(language, {
          created_at: (0,_shared_utility__WEBPACK_IMPORTED_MODULE_9__.convertDate)(language.created_at),
          flag: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)("div", {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch((0,_store_actions_backend_languages__WEBPACK_IMPORTED_MODULE_8__.getLanguages)(page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch((0,_store_actions_backend_languages__WEBPACK_IMPORTED_MODULE_8__.deleteLanguages)(id));
    },
    reset: function reset() {
      return dispatch((0,_store_actions_backend_languages__WEBPACK_IMPORTED_MODULE_8__.resetLanguages)());
    }
  };
};
