"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_src_containers_Backend_Manager_Elders_index_js"],{
...
/***/ "./resources/js/src/containers/Backend/Manager/Elders/index.js":
/*!*********************************************************************!*\
  !*** ./resources/js/src/containers/Backend/Manager/Elders/index.js ***!
  \*********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _store_actions_backend_elders__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../store/actions/backend/elders */ "./resources/js/src/store/actions/backend/elders.js");
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          form = _this$props$content$c.backend.pages.elders.form,
          _this$props$backend$e = _this$props.backend.elders.elders,
          elders = _this$props$backend$e === void 0 ? [] : _this$props$backend$e;
      var lang = localStorage.getItem('lang');
      var data = elders.map(function (elder) {
        var title = elder.title[lang];
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_5__.updateObject)(elder, {
          created_at: (0,_shared_utility__WEBPACK_IMPORTED_MODULE_5__.convertDate)(elder.created_at),
          title: title,
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch(_store_actions_backend_elders__WEBPACK_IMPORTED_MODULE_4__["default"].get(page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch(_store_actions_backend_elders__WEBPACK_IMPORTED_MODULE_4__["default"]["delete"](id));
    },
    reset: function reset() {
      return dispatch(_store_actions_backend_elders__WEBPACK_IMPORTED_MODULE_4__["default"].reset());
    }
  };
};
