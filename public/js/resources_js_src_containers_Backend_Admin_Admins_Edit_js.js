(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_src_containers_Backend_Admin_Admins_Edit_js"],{
...
/***/ "./resources/js/src/containers/Backend/Admin/Admins/Add.js":
/*!*****************************************************************!*\
  !*** ./resources/js/src/containers/Backend/Admin/Admins/Add.js ***!
  \*****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _store_actions_backend_admins__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../../../store/actions/backend/admins */ "./resources/js/src/store/actions/backend/admins.js");
  ...
  _createClass(Add, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (!prevProps.backend.admins.admin && this.props.backend.admins.admin) {
        var admin = this.props.backend.admins.admin;
        this.setState(_objectSpread({}, admin));
      }
      ...
      if (this.props.edit && !prevProps.backend.admins.message && this.props.backend.admins.message && this.props.backend.admins.message.type === 'success') {
        var photo = this.props.backend.admins.admin.photo;
        this.setState({
          photo: photo
        });
      }
    ...
    value: function render() {
      var _this$props = this.props,
          _this$props$content$c = _this$props.content.cms.pages.backend.pages.admins,
          ...
          admin = _this$props$backend$a.admin;
                ...
                children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsx)("div", {
                  ...
                  children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsx)(reactstrap__WEBPACK_IMPORTED_MODULE_18__["default"], {
                    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsx)("div", {
                      ...
                      children: this.props.edit ? photo && photo !== admin.photo && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsxs)("div", {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(id) {
      return dispatch((0,_store_actions_backend_admins__WEBPACK_IMPORTED_MODULE_13__.getAdmin)(id));
    },
    post: function post(data) {
      return dispatch((0,_store_actions_backend_admins__WEBPACK_IMPORTED_MODULE_13__.postAdmins)(data));
    },
    patch: function patch(id, data) {
      return dispatch((0,_store_actions_backend_admins__WEBPACK_IMPORTED_MODULE_13__.patchAdmins)(id, data));
    },
    reset: function reset() {
      return dispatch((0,_store_actions_backend_admins__WEBPACK_IMPORTED_MODULE_13__.resetAdmins)());
    }
  };
};
...
/***/ "./resources/js/src/containers/Backend/Admin/Admins/Edit.js":
/*!******************************************************************!*\
  !*** ./resources/js/src/containers/Backend/Admin/Admins/Edit.js ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var _Add__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Add */ "./resources/js/src/containers/Backend/Admin/Admins/Add.js");
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! react/jsx-runtime */ "./node_modules/react/jsx-runtime.js");
...
var resetAdmins = function resetAdmins() {
  return {
    type: _actionTypes__WEBPACK_IMPORTED_MODULE_0__.ADMINS_RESET
  };
};

var adminsStart = function adminsStart() {
  return {
    type: _actionTypes__WEBPACK_IMPORTED_MODULE_0__.ADMINS_START
  };
};

var adminsSuccess = function adminsSuccess(data) {
  return _objectSpread({
    type: _actionTypes__WEBPACK_IMPORTED_MODULE_0__.ADMINS_SUCCESS
  }, data);
};

var adminsFail = function adminsFail(error) {
  return {
    type: _actionTypes__WEBPACK_IMPORTED_MODULE_0__.ADMINS_FAIL,
    error: error
  };
};
