"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_src_containers_Backend_User_Events_index_js"],{
...
/***/ "./resources/js/src/containers/Backend/User/Events/index.js":
/*!******************************************************************!*\
  !*** ./resources/js/src/containers/Backend/User/Events/index.js ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _store_actions_backend_events__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../../store/actions/backend/events */ "./resources/js/src/store/actions/backend/events.js");
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          _this$props$content$c3 = _this$props$content$c.backend.pages.events,
          ...
          _this$props$backend$e = _this$props.backend.events,
          loading = _this$props$backend$e.loading,
          error = _this$props$backend$e.error,
          message = _this$props$backend$e.message,
          _this$props$backend$e2 = _this$props$backend$e.events,
          events = _this$props$backend$e2 === void 0 ? [] : _this$props$backend$e2,
      ...
      var data = events.map(function (event) {
        var title = event.title[lang];
        var formattedDescription = (0,_shared_utility__WEBPACK_IMPORTED_MODULE_10__.htmlEntities)(event.description[lang]);
        var formattedBody = (0,_shared_utility__WEBPACK_IMPORTED_MODULE_10__.htmlEntities)(event.body[lang]);
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_10__.updateObject)(event, {
          created_at: (0,_shared_utility__WEBPACK_IMPORTED_MODULE_10__.convertDate)(event.created_at),
          date: (0,_shared_utility__WEBPACK_IMPORTED_MODULE_10__.convertDate)(event.date),
          title: title,
          ...
          photo: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_components_Backend_UI_List_Photo__WEBPACK_IMPORTED_MODULE_5__["default"], {
            photo: event.photo,
            see: see,
            title: "".concat(form.event_photo, ": ").concat(title)
          }),
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch((0,_store_actions_backend_events__WEBPACK_IMPORTED_MODULE_9__.getEvents)(page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch((0,_store_actions_backend_events__WEBPACK_IMPORTED_MODULE_9__.deleteEvents)(id));
    },
    reset: function reset() {
      return dispatch((0,_store_actions_backend_events__WEBPACK_IMPORTED_MODULE_9__.resetEvents)());
    }
  };
};
...
/***/ "./resources/js/src/store/actions/backend/events.js":
/*!**********************************************************!*\
  !*** ./resources/js/src/store/actions/backend/events.js ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "getEventsInfo": () => (/* binding */ getEventsInfo),
/* harmony export */   "patchEvents": () => (/* binding */ patchEvents),
/* harmony export */   "postEvents": () => (/* binding */ postEvents),
...
var resource = function resource(type) {
  ...
  return _shared_utility__WEBPACK_IMPORTED_MODULE_0__.manageResource.apply(void 0, ['events', {
    start: function start() {
      return {
        type: _actionTypes__WEBPACK_IMPORTED_MODULE_1__.EVENTS_START
      };
    },
    success: function success(data) {
      return _objectSpread({
        type: _actionTypes__WEBPACK_IMPORTED_MODULE_1__.EVENTS_SUCCESS
      }, data);
    },
    fail: function fail(error) {
      return {
        type: _actionTypes__WEBPACK_IMPORTED_MODULE_1__.EVENTS_FAIL,
        error: error
      };
    }
  }, type].concat(params));
...
var resetEvents = function resetEvents() {
  return {
    type: _actionTypes__WEBPACK_IMPORTED_MODULE_1__.EVENTS_RESET
  };
};
var getEvents = function getEvents(page, show, search) {
  return resource('index', page, show, search);
};
var getEventsInfo = function getEventsInfo() {
  return resource('info');
};
var getEvent = function getEvent(id) {
  return resource('show', id);
};
var postEvents = function postEvents(data) {
  return resource('post', data);
};
var patchEvents = function patchEvents(id, data) {
  return resource('patch', id, data);
};
var deleteEvents = function deleteEvents(id) {
