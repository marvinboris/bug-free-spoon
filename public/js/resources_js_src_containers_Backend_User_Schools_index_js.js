...
/* harmony import */ var _store_actions_backend_schools__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../../store/actions/backend/schools */ "./resources/js/src/store/actions/backend/schools.js");
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var data = schools.map(function (school) {
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_9__.updateObject)(school, {
          created_at: (0,_shared_utility__WEBPACK_IMPORTED_MODULE_9__.convertDate)(school.created_at),
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch((0,_store_actions_backend_schools__WEBPACK_IMPORTED_MODULE_8__.getSchools)(page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch((0,_store_actions_backend_schools__WEBPACK_IMPORTED_MODULE_8__.deleteSchools)(id));
    },
    reset: function reset() {
      return dispatch((0,_store_actions_backend_schools__WEBPACK_IMPORTED_MODULE_8__.resetSchools)());
    }
  };
};
