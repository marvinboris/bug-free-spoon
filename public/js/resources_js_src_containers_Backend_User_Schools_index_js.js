"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_src_containers_Backend_User_Schools_index_js"],{
...
/***/ "./resources/js/src/containers/Backend/User/Schools/index.js":
/*!*******************************************************************!*\
  !*** ./resources/js/src/containers/Backend/User/Schools/index.js ***!
  \*******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _store_actions_backend_schools__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../../store/actions/backend/schools */ "./resources/js/src/store/actions/backend/schools.js");
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          _this$props$content$c3 = _this$props$content$c.backend.pages.schools,
          ...
          _this$props$backend$s = _this$props.backend.schools,
          loading = _this$props$backend$s.loading,
          error = _this$props$backend$s.error,
          message = _this$props$backend$s.message,
          _this$props$backend$s2 = _this$props$backend$s.schools,
          schools = _this$props$backend$s2 === void 0 ? [] : _this$props$backend$s2,
          total = _this$props$backend$s.total,
          features = _this$props.auth.data.role.features;
      var feature = features.find(function (f) {
        return f.prefix === 'schools';
      });
      ...
      var data = schools.map(function (school) {
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_11__.updateObject)(school, {
          created_at: (0,_shared_utility__WEBPACK_IMPORTED_MODULE_11__.convertDate)(school.created_at),
          action: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxs)("div", {
            ...
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(react_router_dom__WEBPACK_IMPORTED_MODULE_14__.Link, {
              to: "/user/schools/".concat(school.id),
              className: "mx-1",
            ...
            }), JSON.parse(feature.permissions).includes('u') && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(react_router_dom__WEBPACK_IMPORTED_MODULE_14__.Link, {
              to: "/user/schools/".concat(school.id, "/edit"),
              className: "mx-1",
              children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_2__.FontAwesomeIcon, {
              ...
              children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_components_Backend_UI_Delete_Delete__WEBPACK_IMPORTED_MODULE_8__["default"], {
                deleteAction: function deleteAction() {
                  return _this.props["delete"](school.id);
                },
                children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_2__.FontAwesomeIcon, {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch((0,_store_actions_backend_schools__WEBPACK_IMPORTED_MODULE_10__.getSchools)(page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch((0,_store_actions_backend_schools__WEBPACK_IMPORTED_MODULE_10__.deleteSchools)(id));
    },
    reset: function reset() {
      return dispatch((0,_store_actions_backend_schools__WEBPACK_IMPORTED_MODULE_10__.resetSchools)());
    }
  };
};
...
/***/ "./resources/js/src/store/actions/backend/schools.js":
/*!***********************************************************!*\
  !*** ./resources/js/src/store/actions/backend/schools.js ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "deleteSchools": () => (/* binding */ deleteSchools),
/* harmony export */   "getSchool": () => (/* binding */ getSchool),
/* harmony export */   "getSchools": () => (/* binding */ getSchools),
/* harmony export */   "getSchoolsInfo": () => (/* binding */ getSchoolsInfo),
/* harmony export */   "patchSchools": () => (/* binding */ patchSchools),
/* harmony export */   "postSchools": () => (/* binding */ postSchools),
/* harmony export */   "resetSchools": () => (/* binding */ resetSchools)
/* harmony export */ });
...
var resource = function resource(type) {
  ...
  return _shared_utility__WEBPACK_IMPORTED_MODULE_0__.manageResource.apply(void 0, ['schools', {
    start: function start() {
      return {
        type: _actionTypes__WEBPACK_IMPORTED_MODULE_1__.SCHOOLS_START
      };
    },
    success: function success(data) {
      return _objectSpread({
        type: _actionTypes__WEBPACK_IMPORTED_MODULE_1__.SCHOOLS_SUCCESS
      }, data);
    },
    fail: function fail(error) {
      return {
        type: _actionTypes__WEBPACK_IMPORTED_MODULE_1__.SCHOOLS_FAIL,
        error: error
      };
    }
  }, type].concat(params));
...
var resetSchools = function resetSchools() {
  return {
    type: _actionTypes__WEBPACK_IMPORTED_MODULE_1__.SCHOOLS_RESET
  };
};
var getSchools = function getSchools(page, show, search) {
  return resource('index', page, show, search);
};
var getSchoolsInfo = function getSchoolsInfo() {
  return resource('info');
};
var getSchool = function getSchool(id) {
  return resource('show', id);
};
var postSchools = function postSchools(data) {
  return resource('post', data);
};
var patchSchools = function patchSchools(id, data) {
  return resource('patch', id, data);
};
var deleteSchools = function deleteSchools(id) {
