"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_src_containers_Backend_Manager_Activities_index_js"],{
...
/***/ "./resources/js/src/containers/Backend/Manager/Activities/index.js":
/*!*************************************************************************!*\
  !*** ./resources/js/src/containers/Backend/Manager/Activities/index.js ***!
  \*************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _store_actions_backend_contributions__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../store/actions/backend/contributions */ "./resources/js/src/store/actions/backend/contributions.js");
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          form = _this$props$content$c.backend.pages.activities.form,
          _this$props$backend$a = _this$props.backend.activities.activities,
          activities = _this$props$backend$a === void 0 ? [] : _this$props$backend$a;
      var lang = localStorage.getItem('lang');
      var data = activities.map(function (activity) {
        var title = activity.title[lang];
        var formattedBody = (0,_shared_utility__WEBPACK_IMPORTED_MODULE_5__.htmlEntities)(activity.body[lang]);
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_5__.updateObject)(activity, {
          created_at: (0,_shared_utility__WEBPACK_IMPORTED_MODULE_5__.convertDate)(activity.created_at),
          title: title,
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch(_store_actions_backend_contributions__WEBPACK_IMPORTED_MODULE_4__["default"].get(page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch(_store_actions_backend_contributions__WEBPACK_IMPORTED_MODULE_4__["default"]["delete"](id));
    },
    reset: function reset() {
      return dispatch(_store_actions_backend_contributions__WEBPACK_IMPORTED_MODULE_4__["default"].reset());
    }
  };
};
