"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_src_containers_Backend_User_Subscribers_Edit_js"],{
...
/***/ "./resources/js/src/containers/Backend/User/Subscribers/Add.js":
/*!*********************************************************************!*\
  !*** ./resources/js/src/containers/Backend/User/Subscribers/Add.js ***!
  \*********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _store_actions_backend_subscribers__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../../store/actions/backend/subscribers */ "./resources/js/src/store/actions/backend/subscribers.js");
  ...
  _createClass(Add, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (!prevProps.backend.subscribers.subscriber && this.props.backend.subscribers.subscriber) {
        var subscriber = this.props.backend.subscribers.subscriber;
        this.setState(_objectSpread({}, subscriber));
      }
    }
  }, {
    ...
    value: function render() {
      var _this$props = this.props,
          _this$props$content$c = _this$props.content.cms.pages.backend.pages.subscribers,
          ...
          _this$props$backend$s = _this$props.backend.subscribers,
      ...
      var content = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(reactstrap__WEBPACK_IMPORTED_MODULE_12__["default"], {
        xs: 12,
      ...
      var feature = features.find(function (f) {
        return f.prefix === 'subscribers';
      });

      var redirect = !(feature && JSON.parse(feature.permissions).includes(this.props.edit ? 'u' : 'c')) && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(react_router_dom__WEBPACK_IMPORTED_MODULE_13__.Redirect, {
        to: "/user/dashboard"
      });
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(id) {
      return dispatch((0,_store_actions_backend_subscribers__WEBPACK_IMPORTED_MODULE_10__.getSubscriber)(id));
    },
    post: function post(data) {
      return dispatch((0,_store_actions_backend_subscribers__WEBPACK_IMPORTED_MODULE_10__.postSubscribers)(data));
    },
    patch: function patch(id, data) {
      return dispatch((0,_store_actions_backend_subscribers__WEBPACK_IMPORTED_MODULE_10__.patchSubscribers)(id, data));
    },
    reset: function reset() {
      return dispatch((0,_store_actions_backend_subscribers__WEBPACK_IMPORTED_MODULE_10__.resetSubscribers)());
    }
  };
};

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,react_router_dom__WEBPACK_IMPORTED_MODULE_13__.withRouter)((0,react_redux__WEBPACK_IMPORTED_MODULE_1__.connect)(mapStateToProps, mapDispatchToProps)(Add)));

/***/ }),

/***/ "./resources/js/src/containers/Backend/User/Subscribers/Edit.js":
/*!**********************************************************************!*\
  !*** ./resources/js/src/containers/Backend/User/Subscribers/Edit.js ***!
  \**********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var _Add__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Add */ "./resources/js/src/containers/Backend/User/Subscribers/Add.js");
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! react/jsx-runtime */ "./node_modules/react/jsx-runtime.js");
...
/***/ "./resources/js/src/store/actions/backend/subscribers.js":
/*!***************************************************************!*\
  !*** ./resources/js/src/store/actions/backend/subscribers.js ***!
  \***************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "deleteSubscribers": () => (/* binding */ deleteSubscribers),
/* harmony export */   "getSubscriber": () => (/* binding */ getSubscriber),
/* harmony export */   "getSubscribers": () => (/* binding */ getSubscribers),
/* harmony export */   "getSubscribersInfo": () => (/* binding */ getSubscribersInfo),
/* harmony export */   "patchSubscribers": () => (/* binding */ patchSubscribers),
/* harmony export */   "postSubscribers": () => (/* binding */ postSubscribers),
/* harmony export */   "resetSubscribers": () => (/* binding */ resetSubscribers)
/* harmony export */ });
...
var resource = function resource(type) {
  ...
  return _shared_utility__WEBPACK_IMPORTED_MODULE_0__.manageResource.apply(void 0, ['subscribers', {
    start: function start() {
      return {
        type: _actionTypes__WEBPACK_IMPORTED_MODULE_1__.SUBSCRIBERS_START
      };
    },
    success: function success(data) {
      return _objectSpread({
        type: _actionTypes__WEBPACK_IMPORTED_MODULE_1__.SUBSCRIBERS_SUCCESS
      }, data);
    },
    fail: function fail(error) {
      return {
        type: _actionTypes__WEBPACK_IMPORTED_MODULE_1__.SUBSCRIBERS_FAIL,
        error: error
      };
    }
  }, type].concat(params));
...
var resetSubscribers = function resetSubscribers() {
  return {
    type: _actionTypes__WEBPACK_IMPORTED_MODULE_1__.SUBSCRIBERS_RESET
  };
};
var getSubscribers = function getSubscribers(page, show, search) {
  return resource('index', page, show, search);
};
var getSubscribersInfo = function getSubscribersInfo() {
  return resource('info');
};
var getSubscriber = function getSubscriber(id) {
  return resource('show', id);
};
var postSubscribers = function postSubscribers(data) {
  return resource('post', data);
};
var patchSubscribers = function patchSubscribers(id, data) {
  return resource('patch', id, data);
};
var deleteSubscribers = function deleteSubscribers(id) {
