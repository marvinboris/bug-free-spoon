"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_src_containers_Backend_User_Activities_index_js"],{
...
/***/ "./resources/js/src/containers/Backend/User/Activities/index.js":
/*!**********************************************************************!*\
  !*** ./resources/js/src/containers/Backend/User/Activities/index.js ***!
  \**********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _store_actions_backend_activities__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../../store/actions/backend/activities */ "./resources/js/src/store/actions/backend/activities.js");
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          _this$props$content$c3 = _this$props$content$c.backend.pages.activities,
      ...
      var data = activities.map(function (activity) {
        var title = activity.title[lang];
        var formattedBody = (0,_shared_utility__WEBPACK_IMPORTED_MODULE_10__.htmlEntities)(activity.body[lang]);
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_10__.updateObject)(activity, {
          created_at: (0,_shared_utility__WEBPACK_IMPORTED_MODULE_10__.convertDate)(activity.created_at),
          title: title,
          ...
          photo: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_components_Backend_UI_List_Photo__WEBPACK_IMPORTED_MODULE_5__["default"], {
            ...
            see: see,
            title: "".concat(form.activity_photo, ": ").concat(title)
          }),
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch((0,_store_actions_backend_activities__WEBPACK_IMPORTED_MODULE_9__.getActivities)(page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch((0,_store_actions_backend_activities__WEBPACK_IMPORTED_MODULE_9__.deleteActivities)(id));
    },
    reset: function reset() {
      return dispatch((0,_store_actions_backend_activities__WEBPACK_IMPORTED_MODULE_9__.resetActivities)());
    }
  };
};
...
/***/ "./resources/js/src/store/actions/backend/activities.js":
/*!**************************************************************!*\
  !*** ./resources/js/src/store/actions/backend/activities.js ***!
  \**************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "deleteActivities": () => (/* binding */ deleteActivities),
/* harmony export */   "getActivities": () => (/* binding */ getActivities),
/* harmony export */   "getActivitiesInfo": () => (/* binding */ getActivitiesInfo),
/* harmony export */   "getActivity": () => (/* binding */ getActivity),
/* harmony export */   "patchActivities": () => (/* binding */ patchActivities),
/* harmony export */   "postActivities": () => (/* binding */ postActivities),
...
var resource = function resource(type) {
  ...
  return _shared_utility__WEBPACK_IMPORTED_MODULE_0__.manageResource.apply(void 0, ['activities', {
    start: function start() {
      return {
        type: _actionTypes__WEBPACK_IMPORTED_MODULE_1__.ACTIVITIES_START
      };
    },
    success: function success(data) {
      return _objectSpread({
        type: _actionTypes__WEBPACK_IMPORTED_MODULE_1__.ACTIVITIES_SUCCESS
      }, data);
    },
    fail: function fail(error) {
      return {
        type: _actionTypes__WEBPACK_IMPORTED_MODULE_1__.ACTIVITIES_FAIL,
        error: error
      };
    }
  }, type].concat(params));
...
var resetActivities = function resetActivities() {
  return {
    type: _actionTypes__WEBPACK_IMPORTED_MODULE_1__.ACTIVITIES_RESET
  };
};
var getActivities = function getActivities(page, show, search) {
  return resource('index', page, show, search);
};
var getActivitiesInfo = function getActivitiesInfo() {
  return resource('info');
};
var getActivity = function getActivity(id) {
  return resource('show', id);
};
var postActivities = function postActivities(data) {
  return resource('post', data);
};
var patchActivities = function patchActivities(id, data) {
