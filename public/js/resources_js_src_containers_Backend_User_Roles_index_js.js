...
/* harmony import */ var _store_actions_backend_roles__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../../store/actions/backend/roles */ "./resources/js/src/store/actions/backend/roles.js");
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          _this$props$backend$r2 = _this$props$backend$r.roles,
          roles = _this$props$backend$r2 === void 0 ? [] : _this$props$backend$r2,
      ...
      var data = roles.map(function (role) {
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_9__.updateObject)(role, {
          created_at: (0,_shared_utility__WEBPACK_IMPORTED_MODULE_9__.convertDate)(role.created_at),
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch((0,_store_actions_backend_roles__WEBPACK_IMPORTED_MODULE_8__.getRoles)(page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch((0,_store_actions_backend_roles__WEBPACK_IMPORTED_MODULE_8__.deleteRoles)(id));
    },
    reset: function reset() {
      return dispatch((0,_store_actions_backend_roles__WEBPACK_IMPORTED_MODULE_8__.resetRoles)());
    }
  };
};
