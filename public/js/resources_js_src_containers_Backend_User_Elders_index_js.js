"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_src_containers_Backend_User_Elders_index_js"],{
...
/***/ "./resources/js/src/containers/Backend/User/Elders/index.js":
/*!******************************************************************!*\
  !*** ./resources/js/src/containers/Backend/User/Elders/index.js ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _store_actions_backend_elders__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../../store/actions/backend/elders */ "./resources/js/src/store/actions/backend/elders.js");
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          _this$props$content$c3 = _this$props$content$c.backend.pages.elders,
          ...
          _this$props$backend$e = _this$props.backend.elders,
          loading = _this$props$backend$e.loading,
          error = _this$props$backend$e.error,
          message = _this$props$backend$e.message,
          _this$props$backend$e2 = _this$props$backend$e.elders,
          elders = _this$props$backend$e2 === void 0 ? [] : _this$props$backend$e2,
      ...
      var data = elders.map(function (elder) {
        var title = elder.title[lang];
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_10__.updateObject)(elder, {
          created_at: (0,_shared_utility__WEBPACK_IMPORTED_MODULE_10__.convertDate)(elder.created_at),
          title: title,
          ...
          payment: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_components_Backend_UI_List_Photo__WEBPACK_IMPORTED_MODULE_5__["default"], {
            photo: elder.payment,
            see: see,
            title: "".concat(form.payment, ": ").concat(elder.name)
          }),
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch((0,_store_actions_backend_elders__WEBPACK_IMPORTED_MODULE_9__.getElders)(page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch((0,_store_actions_backend_elders__WEBPACK_IMPORTED_MODULE_9__.deleteElders)(id));
    },
    reset: function reset() {
      return dispatch((0,_store_actions_backend_elders__WEBPACK_IMPORTED_MODULE_9__.resetElders)());
    }
  };
};
