...
/* harmony import */ var _store_actions_backend_users__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../../../store/actions/backend/users */ "./resources/js/src/store/actions/backend/users.js");
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var data = users.map(function (user) {
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_13__.updateObject)(user, {
          created_at: (0,_shared_utility__WEBPACK_IMPORTED_MODULE_13__.convertDate)(user.created_at),
          photo: user.photo && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsxs)("div", {
            className: "d-flex",
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch((0,_store_actions_backend_users__WEBPACK_IMPORTED_MODULE_12__.getUsers)(page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch((0,_store_actions_backend_users__WEBPACK_IMPORTED_MODULE_12__.deleteUsers)(id));
    },
    reset: function reset() {
      return dispatch((0,_store_actions_backend_users__WEBPACK_IMPORTED_MODULE_12__.resetUsers)());
    }
  };
};
