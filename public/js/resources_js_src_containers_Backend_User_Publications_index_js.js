"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_src_containers_Backend_User_Publications_index_js"],{
...
/***/ "./resources/js/src/containers/Backend/User/Publications/index.js":
/*!************************************************************************!*\
  !*** ./resources/js/src/containers/Backend/User/Publications/index.js ***!
  \************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _store_actions_backend_publications__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../../store/actions/backend/publications */ "./resources/js/src/store/actions/backend/publications.js");
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          _this$props$content$c3 = _this$props$content$c.backend.pages.publications,
          ...
          _this$props$backend$p = _this$props.backend.publications,
          loading = _this$props$backend$p.loading,
          error = _this$props$backend$p.error,
          message = _this$props$backend$p.message,
          _this$props$backend$p2 = _this$props$backend$p.publications,
          publications = _this$props$backend$p2 === void 0 ? [] : _this$props$backend$p2,
          total = _this$props$backend$p.total,
          features = _this$props.auth.data.role.features;
      var lang = localStorage.getItem('lang');
      var feature = features.find(function (f) {
        return f.prefix === 'publications';
      });
      ...
      var data = publications.map(function (publication) {
        ...
        var formattedBody = (0,_shared_utility__WEBPACK_IMPORTED_MODULE_10__.htmlEntities)(publication.body[lang]);
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_10__.updateObject)(publication, {
          created_at: (0,_shared_utility__WEBPACK_IMPORTED_MODULE_10__.convertDate)(publication.created_at),
          title: title,
          body: formattedBody.length > 90 ? formattedBody.substr(0, 90) + '...' : formattedBody,
          photo: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_components_Backend_UI_List_Photo__WEBPACK_IMPORTED_MODULE_5__["default"], {
      ...
      var content = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_components_Backend_UI_List__WEBPACK_IMPORTED_MODULE_4__["default"], {
        array: data,
        loading: loading,
        data: JSON.stringify(publications),
        get: this.props.get,
        total: total,
        bordered: true,
        add: add,
        link: "/user/publications/add",
        icon: icon,
        title: index,
        className: "shadow-sm",
        fields: [{
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch((0,_store_actions_backend_publications__WEBPACK_IMPORTED_MODULE_9__.getPublications)(page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch((0,_store_actions_backend_publications__WEBPACK_IMPORTED_MODULE_9__.deletePublications)(id));
    },
    reset: function reset() {
      return dispatch((0,_store_actions_backend_publications__WEBPACK_IMPORTED_MODULE_9__.resetPublications)());
    }
  };
};
...
/***/ "./resources/js/src/store/actions/backend/publications.js":
/*!****************************************************************!*\
  !*** ./resources/js/src/store/actions/backend/publications.js ***!
  \****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "deletePublications": () => (/* binding */ deletePublications),
/* harmony export */   "getPublication": () => (/* binding */ getPublication),
/* harmony export */   "getPublications": () => (/* binding */ getPublications),
/* harmony export */   "getPublicationsInfo": () => (/* binding */ getPublicationsInfo),
/* harmony export */   "patchPublications": () => (/* binding */ patchPublications),
/* harmony export */   "postPublications": () => (/* binding */ postPublications),
...
var resource = function resource(type) {
  ...
  return _shared_utility__WEBPACK_IMPORTED_MODULE_0__.manageResource.apply(void 0, ['publications', {
    start: function start() {
      return {
        type: _actionTypes__WEBPACK_IMPORTED_MODULE_1__.PUBLICATIONS_START
      };
    },
    success: function success(data) {
      return _objectSpread({
        type: _actionTypes__WEBPACK_IMPORTED_MODULE_1__.PUBLICATIONS_SUCCESS
      }, data);
    },
    fail: function fail(error) {
      return {
        type: _actionTypes__WEBPACK_IMPORTED_MODULE_1__.PUBLICATIONS_FAIL,
        error: error
      };
    }
  }, type].concat(params));
...
var resetPublications = function resetPublications() {
  return {
    type: _actionTypes__WEBPACK_IMPORTED_MODULE_1__.PUBLICATIONS_RESET
  };
};
var getPublications = function getPublications(page, show, search) {
  return resource('index', page, show, search);
};
var getPublicationsInfo = function getPublicationsInfo() {
  return resource('info');
};
var getPublication = function getPublication(id) {
  return resource('show', id);
};
var postPublications = function postPublications(data) {
  return resource('post', data);
};
var patchPublications = function patchPublications(id, data) {
  return resource('patch', id, data);
};
var deletePublications = function deletePublications(id) {
