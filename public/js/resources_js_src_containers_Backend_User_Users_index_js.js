"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_src_containers_Backend_User_Users_index_js"],{
...
/* harmony import */ var _store_actions_backend_users__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../../store/actions/backend/users */ "./resources/js/src/store/actions/backend/users.js");
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          _this$props$backend$u2 = _this$props$backend$u.users,
          users = _this$props$backend$u2 === void 0 ? [] : _this$props$backend$u2,
      ...
      var data = users.map(function (user) {
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_11__.updateObject)(user, {
          created_at: (0,_shared_utility__WEBPACK_IMPORTED_MODULE_11__.convertDate)(user.created_at),
          photo: user.photo && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxs)("div", {
            className: "d-flex",
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)("span", {
              ...
              children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_components_Backend_UI_View_View__WEBPACK_IMPORTED_MODULE_5__["default"], {
                title: "".concat(form.user_photo, ": ").concat(user.name),
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch((0,_store_actions_backend_users__WEBPACK_IMPORTED_MODULE_10__.getUsers)(page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch((0,_store_actions_backend_users__WEBPACK_IMPORTED_MODULE_10__.deleteUsers)(id));
    },
    reset: function reset() {
      return dispatch((0,_store_actions_backend_users__WEBPACK_IMPORTED_MODULE_10__.resetUsers)());
    }
  };
};
