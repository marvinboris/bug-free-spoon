...
var SubNavLinks = function SubNavLinks(_ref) {
  ...
  var resourceTabPanes = keys.map(function (item) {
    var currentItem = _components_Content_Components__WEBPACK_IMPORTED_MODULE_11__["default"][item];
  ...
  _createClass(Components, [{
    ...
    value: function getDerivedStateFromProps(nextProps, prevState) {
      if (nextProps.backend.cms.cms && prevState.app_name === '') {
        ...
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_10__.updateObject)(prevState, _objectSpread({}, components));
      }
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    ...
    patch: function patch(data) {
      return dispatch((0,_store_actions_backend_cms__WEBPACK_IMPORTED_MODULE_9__.patchCms)('components', data));
    },
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,react_router_dom__WEBPACK_IMPORTED_MODULE_21__.withRouter)((0,react_redux__WEBPACK_IMPORTED_MODULE_1__.connect)(mapStateToProps, mapDispatchToProps)(Components)));
