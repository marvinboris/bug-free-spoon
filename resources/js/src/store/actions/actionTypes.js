...
export const ALUMNI_CALL_RESET = 'ALUMNI_CALL_RESET';
export const ALUMNI_CALL_START = 'ALUMNI_CALL_START';
export const ALUMNI_CALL_SUCCESS = 'ALUMNI_CALL_SUCCESS';
export const ALUMNI_CALL_FAIL = 'ALUMNI_CALL_FAIL';

export const COMMITTEE_RESET = 'COMMITTEE_RESET';
export const COMMITTEE_START = 'COMMITTEE_START';
export const COMMITTEE_SUCCESS = 'COMMITTEE_SUCCESS';
export const COMMITTEE_FAIL = 'COMMITTEE_FAIL';

export const OPPORTUNITIES_RESET = 'OPPORTUNITIES_RESET';
export const OPPORTUNITIES_START = 'OPPORTUNITIES_START';
export const OPPORTUNITIES_SUCCESS = 'OPPORTUNITIES_SUCCESS';
export const OPPORTUNITIES_FAIL = 'OPPORTUNITIES_FAIL';
...
export const ACTIVITIES_RESET = 'ACTIVITIES_RESET';
...
export const ELDERS_RESET = 'ELDERS_RESET';
export const ELDERS_START = 'ELDERS_START';
export const ELDERS_SUCCESS = 'ELDERS_SUCCESS';
export const ELDERS_FAIL = 'ELDERS_FAIL';

export const SUBSCRIBERS_RESET = 'SUBSCRIBERS_RESET';
export const SUBSCRIBERS_START = 'SUBSCRIBERS_START';
export const SUBSCRIBERS_SUCCESS = 'SUBSCRIBERS_SUCCESS';
export const SUBSCRIBERS_FAIL = 'SUBSCRIBERS_FAIL';

export const CONTRIBUTIONS_RESET = 'CONTRIBUTIONS_RESET';
export const CONTRIBUTIONS_START = 'CONTRIBUTIONS_START';
export const CONTRIBUTIONS_SUCCESS = 'CONTRIBUTIONS_SUCCESS';
export const CONTRIBUTIONS_FAIL = 'CONTRIBUTIONS_FAIL';

export const SCHOOLS_RESET = 'SCHOOLS_RESET';
export const SCHOOLS_START = 'SCHOOLS_START';
export const SCHOOLS_SUCCESS = 'SCHOOLS_SUCCESS';
export const SCHOOLS_FAIL = 'SCHOOLS_FAIL';